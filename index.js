...
class MusicPlayer {
    constructor(
        data = {
            ...
            songObjArr: [
                {
                    title: "イタズラものたちの行進",  // 歌曲名
                    author: "ジャージと愉快な仲間たち",   // 歌手
                    imgSrc: "./public/images/ジャージと愉快な仲間たち - イタズラものたちの行進.jpg", // 图片路径
                    url: "./public/audios/ジャージと愉快な仲間たち - イタズラものたちの行進.mp3", // 音频路径
                },
                {
                    title: "近く远い斜め色の空",
                    author: "DDBY",
                    imgSrc: "./public/images/DDBY - 近く远い斜め色の空.png",
                    url: "./public/audios/DDBY - 近く远い斜め色の空.mp3",
                },
                {
                    title: "Lemon Tree",
